...
const TestContractABI = "[{\"inputs\":[],\"name\":\"Get\",\"outputs\":[{\"internalType\":\"uint256\",\"name\":\"\",\"type\":\"uint256\"}],\"stateMutability\":\"view\",\"type\":\"function\"},{\"inputs\":[{\"internalType\":\"uint256\",\"name\":\"i\",\"type\":\"uint256\"}],\"name\":\"Set\",\"outputs\":[],\"stateMutability\":\"nonpayable\",\"type\":\"function\"}]"

// TestContractBin is the compiled bytecode used for deploying new contracts.
var TestContractBin = ""
...
func (_TestContract *TestContractCaller) Get(opts *bind.CallOpts) (*big.Int, error) {
	var out []interface{}
	err := _TestContract.contract.Call(opts, &out, "Get")
...
//
// Solidity: function Get() view returns(uint256)
func (_TestContract *TestContractSession) Get() (*big.Int, error) {
	return _TestContract.Contract.Get(&_TestContract.CallOpts)
}

// Get is a free data retrieval call binding the contract method 0xb1976a02.
//
// Solidity: function Get() view returns(uint256)
func (_TestContract *TestContractCallerSession) Get() (*big.Int, error) {
	return _TestContract.Contract.Get(&_TestContract.CallOpts)
}

// Set is a paid mutator transaction binding the contract method 0xdf7a95ae.
//
// Solidity: function Set(uint256 i) returns()
func (_TestContract *TestContractTransactor) Set(opts *bind.TransactOpts, i *big.Int) (*types.Transaction, error) {
	return _TestContract.contract.Transact(opts, "Set", i)
}

// Set is a paid mutator transaction binding the contract method 0xdf7a95ae.
//
// Solidity: function Set(uint256 i) returns()
func (_TestContract *TestContractSession) Set(i *big.Int) (*types.Transaction, error) {
	return _TestContract.Contract.Set(&_TestContract.TransactOpts, i)
}

// Set is a paid mutator transaction binding the contract method 0xdf7a95ae.
//
// Solidity: function Set(uint256 i) returns()
func (_TestContract *TestContractTransactorSession) Set(i *big.Int) (*types.Transaction, error) {
	return _TestContract.Contract.Set(&_TestContract.TransactOpts, i)
}
